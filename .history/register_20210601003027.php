...
<body>
    ...
    if (empty($_POST)) {
        exit("Les données du formulaire que vous avez soumises dépassent您提交的表单数据超过post_max_size! <br>");
    }
    ...
    if ($password != $confirmPassword) {
        exit("Le mot de passe saisi n'est pas égal au mot de passe confirmé输入的密码与确认密码不相等！");  //
    }
