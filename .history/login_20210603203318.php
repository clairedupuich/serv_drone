        ...
        <section class="navLogo">
            ...
            <div class="navAndIcon">
                <ul class="nav">
                    ...
                    <li class=""> <a href="nos_produit.html"> Nos services</a></li>
                    <li class=""> <a href="histoire.html"> Histoire</a></li>
                ...
                <div class="iconHeader">
                  ...
                  <a href="" class="iconHaut"><img src="img/panier.png" class="ico_right" alt=""></a>
                </div>
            </div>
        </section>
...
<h1 class="box-logo box-title">Vous avez deja inscrit, connectez vous ici</h1>
