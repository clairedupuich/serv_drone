...
<div class="body_form">
<h2 class="title_box">Vous avez deja inscrit, connectez vous ici</h2>
<form class="box" action="" method="post" name="login">
<h2 class="box-logo box-title">Vous avez deja inscrit, connectez vous ici</h2>
<h2 class="box-title">Connexion</h1>
