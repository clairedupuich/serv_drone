        ...
        <section class="navLogo">
            ...
            <div class="navAndIcon">
                ...
                <div class="iconHeader">
                  ...
                  <a href="" class="iconHaut"><img src="img/Vector(2).png" alt=""></a>
                </div>
            </div>
        </section>
            ...
            <div class="hform">
                <h3>Au plaisir de vous entendre</h1>
                    <p class="contat-p">Nous respectons votre vie privée, ne tolérons pas les spams, ne divulguerons pas
                        vos informations</p>
                    <form action="index.php" class="contact-form "  id="form" enctype="multipart/form-data" onsubmit="return validate()" method="post">
                        <div class="nomemail">
                            <div class="form-nom">
